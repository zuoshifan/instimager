...
class ArbitraryUnpolarisedCylinder(cylinder.UnpolarisedCylinderTelescope):
    """An unpolarized cylinder array with arbitrary number of feeeds and feeds position.
